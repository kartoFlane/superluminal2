...
public enum FieldType
{
	 ...
	 *
	 * @param ch
	 *            the character representing the type (must match one of those listed in
	 ...
	 *            prim_typecode or obj_typecode in the Object Serialization Stream Protocol)
	 * @param javatype
	 *            the name of the object class, where applicable (or null if not)
	 */
	 ...
	 *
	 * @param b
	 *            the type code; must be one of the charcaters in obj_typecode or
